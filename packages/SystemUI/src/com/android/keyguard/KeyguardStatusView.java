...
public class KeyguardStatusView extends GridLayout implements
    ...
    private void refreshTime() {
        ...
        if (mClockSelection == 2) {
            ...
            mClockView.setFormat12Hour(Html.fromHtml("<font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.custom_text_clock_top_color)) + ">hh</font><br>mm"));
            mClockView.setFormat24Hour(Html.fromHtml("<font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.custom_text_clock_top_color)) + ">kk</font><br>mm"));
        } else if (mClockSelection == 7) {
            mClockView.setFormat12Hour(Html.fromHtml("hh<br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.custom_text_clock_top_color)) + ">mm</font>"));
            mClockView.setFormat24Hour(Html.fromHtml("kk<br><font color=" + AccentUtils.getAccentColor(getResources().getColor(R.color.custom_text_clock_top_color)) + ">mm</font>"));
