...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private boolean mVolumePanelOnLeft = false;
    ...
    private void setVolumePanelOnLeft() {
        final boolean volumePanelOnLeft = Settings.Secure.getIntForUser(mContext.getContentResolver(), Settings.Secure.AUDIO_PANEL_VIEW_POSITION, 0, UserHandle.USER_CURRENT) == 0;
